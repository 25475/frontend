...
function PlanCard({name, price, description, features, isPopular, imageUrl}:{name:string, price:number, description:string, features:string[], isPopular?:boolean, imageUrl?:string}){
  ...
  const planImage = imageUrl || getImageForPlan(name)
